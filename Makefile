...
SAMPLES = int.ris float.ris string.ris bool.ris let.ris binOp.ris boolExpr.ris if.ris print.ris function.ris fibonnaci.ris lorem.ris unit.ris double.ris long.ris foreign.ris
